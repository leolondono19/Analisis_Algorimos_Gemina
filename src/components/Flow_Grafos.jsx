    ...
    >
      ...
      {showDocument && (
        <Modal
          ...
          content={
            <iframe
              src="https://docs.google.com/document/d/e/2PACX-1vSROfj6cl2CBumMja16cWapq8mfNz2o6LIYnIK2t-66KyKJB1eSFyZvTGjoC_kTS1ADBoB-Hv5nxX0D/pub"
              width="150%"
              height="800px"
              style={{ border: "none" }}
            ></iframe>
